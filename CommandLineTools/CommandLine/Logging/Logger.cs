...
namespace CommandLineTools.CommandLine
{
    ...
    public class Logger
    {
        private static readonly string DefaultFilePathError = Path.GetFileNameWithoutExtension(Assembly.GetEntryAssembly()?.Location ?? throw new NullReferenceException());
