...
namespace CommandLineTools.CommandLine
{
    ...
    public class Option
    {
        ...
        public IReadOnlyCollection<string> RawAliases
        {
            get { return rawAliases.ToArray(); }
        }
        ...
        internal virtual bool IsCommand
        {
            get { return false; }
        }
        ...
        public Option this[string alias]
        {
            get { return DefinedOptions[alias]; }
        }
        ...
        protected internal Option(string[]       aliases,
                                  string         help,
                                  ArgumentsRule? arguments = null,
                                  Option[]?      options   = null)
        {
            ...
            Name = aliases.Select(a => a.RemovePrefix()).OrderBy(a => a.Length).Last();
        ...
        public IEnumerable<string> Suggest(ParseResult parseResult)
        {
        ...
        {
            return aliases.Contains(alias.RemovePrefix());
        }

        public bool HasRawAlias(string alias)
        {
            return rawAliases.Contains(alias);
        }

        public override string ToString()
        {
            return IsCommand ? Name : RawAliases.Single(a => a.RemovePrefix() == Name);
        }
    }
}