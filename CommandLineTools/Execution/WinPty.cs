...
namespace CommandLineTools.Execution
{
    ...
    public sealed class WinPty : IDisposable
    {
        ...
        internal static class Native
        {
            ...
            [SuppressUnmanagedCodeSecurity, MethodImpl(MethodImplOptions.AggressiveInlining), DllImport(DllName, CharSet = CharSet.Unicode, PreserveSig = true, EntryPoint = "winpty_error_code", ExactSpelling = true, SetLastError = false)]
